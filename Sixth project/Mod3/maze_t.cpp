...
// Incluyo en la parte privada de la clase maze_t en el archivo maze_t.hpp "int count_;"
...
maze_t::solve()
{
  ...
  //Modificación
  cout << "Se ha llamado recursivamente el procedimiento solve_ " << count_ << " veces." << endl;
  return aux;
}
